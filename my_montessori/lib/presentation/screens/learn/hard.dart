...
class _HardLearnLetterScreenState extends State<HardLearnLetterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final currentLetter = syllables[widget.index];
    final bool hasPrev = widget.index > 0;
    final bool hasNext = widget.index < syllables.length - 1;
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Aprende la Silaba ${currentLetter.char}'),
          ...
          SafeArea(
            child: Column(
              children: [
                    ...
                    children: [
                      if (hasPrev)
                        IconButton(
                          ...
                          onPressed: () => Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (_) => HardLearnLetterScreen(index: prevIndex, initialIsUppercase: isUppercase)),
                          ),
                      ...
                      if (hasNext)
                        IconButton(
                          ...
                          onPressed: () => Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (_) => HardLearnLetterScreen(index: nextIndex, initialIsUppercase: isUppercase)),
                          ),
                ...
                // Mostrar grid de selección cuando _useMachineLearning == false
                Expanded(
                  child: _useMachineLearning
                      ? SingleChildScrollView(
                          ...
                          child: Builder(builder: (context) {
                            ...
                            final syllableWords = currentLetter.words.where((w) {
                              final s = w.trim();
                            ...
                            return Wrap(
                              ...
                              children: syllableWords.map((word) {
                                  ...
                                  onPressed: () {
                                    if (!isUppercase && hasNext) {
                                      Navigator.pushReplacement(
                                        context,
                                        MaterialPageRoute(builder: (_) => HardLearnLetterScreen(index: nextIndex, initialIsUppercase: false)),
                                      );
                                      return;
                                    }
                                  },
                            ...
                            itemBuilder: (c, i) {
                              ...
                              return ButtonLetter(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(builder: (_) => HardLearnLetterScreen(index: i, initialIsUppercase: isUppercase)),
                                  );
                                },
                              );
                            },
